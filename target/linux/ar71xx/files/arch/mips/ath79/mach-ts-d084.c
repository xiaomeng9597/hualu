...
#define TS_D084_GPIO_LED_SYSTEM	17
#define TS_D084_GPIO_LED_WLAN	0
#define TS_D084_GPIO_LED_USB	8
...
static struct gpio_led ts_d084_leds_gpio[] __initdata = {
	{
		.name		= "ts-d084:blue:wlan",
		.gpio		= TS_D084_GPIO_LED_WLAN,
		.active_low	= 0,
	},{
		.name		= "ts-d084:blue:usb",
		.gpio		= TS_D084_GPIO_LED_USB,
		.active_low	= 0,
	},{
